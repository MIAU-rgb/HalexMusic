...
class MusicPlayer:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🎵 HalexMusic 2.4V")
        ...
        self.volume = 70
        self.repeat_mode = "off"  # НОВОЕ: off, one, all
        self.custom_tags = {}
        ...
        if os.path.exists(self.settings_file):
            try:
                with open(self.settings_file, 'r', encoding='utf-8') as f:
                    ...
                    self.repeat_mode = data.get('repeat_mode', 'off')  # НОВОЕ
    ...
    def save_settings(self):
        data = {
            ...
            'repeat_mode': self.repeat_mode,  # НОВОЕ
    ...
    # НОВОЕ: Обновление иконки кнопки повтора
    ...
    def setup_ui(self):
        ...
        tk.Label(bottom_frame, text="© 2026 HalexMusic 2.4V | github.com/MIAU-rgb/HalexMusic", 
    ...
    def create_mini_player(self):
        ...
        tk.Label(tb, text="HALEX 2.4V", font=('Segoe UI', 5, 'bold'), fg=ra, bg=rs).pack(side='left', padx=4)
    ...
    # ОБНОВЛЁННЫЙ: next_track с поддержкой повтора
    def next_track(self):
    ...
    def refresh_music(self):
        ...
        self.shuffled_tracks = []
        self.original_tracks = []
        messagebox.showinfo("HalexMusic 2.4V", "Музыка обновлена!")
