...
class MusicPlayer:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🎵 HalexMusic 2.34V")
    ...
    def setup_ui(self):
        ...
        tk.Label(bottom_frame, text="© 2026 HalexMusic 2.34V | github.com/MIAU-rgb/HalexMusic", 
    ...
    def create_mini_player(self):
        ...
        tk.Label(tb, text="HALEX 2.34V", font=('Segoe UI', 5, 'bold'), fg=ra, bg=rs).pack(side='left', padx=4)
    ...
    def refresh_music(self):
        ...
        self.shuffled_tracks = []
        self.original_tracks = []
        messagebox.showinfo("HalexMusic 2.34V", "Музыка обновлена!")
