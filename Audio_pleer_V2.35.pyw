...
class MusicPlayer:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🎵 HalexMusic 2.35V")
    ...
    # ====== ИСПРАВЛЕНО: ТЕГИ МЕНЯЮТ ТОЛЬКО ОТОБРАЖЕНИЕ ======
    def edit_tags(self):
        ...
        def save_tags():
            ...
            # Меняем только в памяти (в словаре трека)
            ...
            # Сохраняем изменения в Info.txt
            self.save_info()
            self.tag_editor_dialog.destroy()
            messagebox.showinfo("Теги", "Отображение изменено!")
    ...
    def setup_ui(self):
        ...
        tk.Label(bottom_frame, text="© 2026 HalexMusic 2.35V | github.com/MIAU-rgb/HalexMusic", 
    ...
    def create_mini_player(self):
        ...
        tk.Label(tb, text="HALEX 2.35V", font=('Segoe UI', 5, 'bold'), fg=ra, bg=rs).pack(side='left', padx=4)
    ...
    def refresh_music(self):
        ...
        self.shuffled_tracks = []
        self.original_tracks = []
        messagebox.showinfo("HalexMusic 2.35V", "Музыка обновлена!")
